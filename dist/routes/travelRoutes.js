...
router.get('/:urlname/travel/:travel_id/approve', _middleware.authUser, _organization.LoggedUserisEmployee, _organization.LoggedUserisAdmin, _travel.approveTravelRequest);
router.get('/:urlname/travel/:travel_id/decline', _middleware.authUser, _organization.LoggedUserisEmployee, _organization.LoggedUserisAdmin, _travel.declineTravelRequest);
